...
public class QuizRepositoryImpl implements QuizRepository {
    ...
    public Long findTodayNormalQuestionCountByDeckId(Long deckId) {
        ...
        return namedParameterJdbcTemplate
                .queryForObject(FIND_TODAY_NORMAL_QUESTION_COUNT_BY_DECK_ID_SQL, params,
                        Long.class);
    }
    ...
    public Long findTodayExtraQuestionCountByDeckId(Long deckId) {
        ...
        params.put("deckId", deckId);
        return namedParameterJdbcTemplate.queryForObject(
                FIND_TODAY_EXTRA_QUESTION_COUNT_BY_DECK_ID_SQL,
                params, Long.class);
    }
    ...
    public Long findCountByDeckIdAndIsNormalModeCorrectTrueAndNextPracticeDate(Long deckId) {
        ...
        params.put("deckId", deckId);
        return namedParameterJdbcTemplate.queryForObject(
                FIND_COUNT_BY_DECK_ID_AND_IS_NORMAL_MODE_CORRECT_TRUE_AND_NEXT_PRACTICE_DATE_SQL,
                params,
                Long.class);
    }
