...
public class QuizRepositoryImpl implements QuizRepository {
  ...
  public List<WordEntity> findRandomWordByDeckIdAndDate(Long deckId) {
    ...
    return namedParameterJdbcTemplate.query(FIND_RANDOM_WORD_BY_DECK_ID_AND_DATE_SQL, params,
  ...
  public Long findTodayNormalQuestionCountByDeckId(Long deckId) {
    ...
    return namedParameterJdbcTemplate
        .queryForObject(FIND_TODAY_NORMAL_QUESTION_COUNT_BY_DECK_ID_SQL, params, Long.class);
  }
  ...
  public Long findTodayExtraQuestionCountByDeckId(Long deckId) {
    Map<String, Object> params = new HashMap<>();
    params.put("deckId", deckId);
    return namedParameterJdbcTemplate.queryForObject(FIND_TODAY_EXTRA_QUESTION_COUNT_BY_DECK_ID_SQL,
        params, Long.class);
  }
  ...
  public List<WordEntity> findExtraWordByDeckId(Long deckId) {
    Map<String, Object> params = new HashMap<>();
    params.put("deckId", deckId);
    return namedParameterJdbcTemplate.query(FIND_EXTRA_WORD_BY_DECK_ID_SQL, params,
        new WordEntityRowMapper());
  }
  ...
  public Long findCountByDeckIdAndIsNormalModeCorrectTrueAndNextPracticeDate(Long deckId) {
    ...
    params.put("deckId", deckId);
    return namedParameterJdbcTemplate.queryForObject(
        FIND_COUNT_BY_DECK_ID_AND_IS_NORMAL_MODE_CORRECT_TRUE_AND_NEXT_PRACTICE_DATE_SQL, params,
        Long.class);
  }
  ...
  public Optional<WordEntity> findById(Long id) {
    try {
      ...
      WordEntity word = namedParameterJdbcTemplate.queryForObject(FIND_BY_ID_SQL, params,
          new WordEntityRowMapper());
